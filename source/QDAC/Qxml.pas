...
{$IFEND >=2010}
  ...
  public
    ...
    function AttrValueByPath(const APath, AttrName, ADefVal: QStringW)
      : QStringW;
    /// <summary>强制一个指定名称节点存在,如果不存在,则创建该结点</summary>
    /// <param name="APath">要添加的结点名称</param>
    /// <returns>返回名称对应的对象</returns>
    function ForceName(AName: QStringW): TQXMLNode;
...
function TQXMLNode.ForceName(AName: QStringW): TQXMLNode;
var
  I: Integer;
begin
  I := IndexOf(AName);
