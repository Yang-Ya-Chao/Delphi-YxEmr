...
type
  ...
  private
    ...
    function FField(Name: string): Boolean;
  ...
  public
    ...
    /// <summary>是否存在某个字段</summary>
    property FF[Name : string] : Boolean     read FField  ;
  end;
implementation

{ TFDQueryHelper }

function TFDQueryHelper.FField(Name: string): Boolean;
begin
  Result := Self.FindField(Name) <> nil;
end;
